...
#define ST7735_2_TFTWIDTH  128
#define ST7735_2_TFTHEIGHT 160


// Color definitions
#define ST7735_2_BLACK   0x0000
#define ST7735_2_BLUE    0xF800
#define ST7735_2_RED     0x001F
#define ST7735_2_GREEN   0x07E0
#define ST7735_2_CYAN    0xFFE0
#define ST7735_2_MAGENTA 0xF81F
#define ST7735_2_YELLOW  0x07FF
#define ST7735_2_WHITE   0xFFFF
...
// Output: none
void ST7735_2_SetRotation(uint8_t m) ;
...
// Outputs: none
void ST7735_2_PlotPoint(int32_t y);
...
// Inputs: y is the y coordinate of the point plotted
// Outputs: none
void ST7735_2_PlotLine(int32_t y);
...
// Outputs: none
void ST7735_2_PlotPoints(int32_t y1,int32_t y2);
...
// Clear display
void Output_2_Clear(void);

// Turn off display (low power)
void Output_2_Off(void);

// Turn on display
void Output_2_On(void);

// set the color for future output
// Background color is fixed at black
// Input:  16-bit packed color
// Output: none
void Output_2_Color(uint32_t newColor); 

void LCD_2_OutDec(uint32_t data);  // output to LCD
